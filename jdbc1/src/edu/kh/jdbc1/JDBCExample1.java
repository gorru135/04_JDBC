...
public class JDBCExample1 {
	...
	public static void main(String[] args) {
		...
		// JDBC(Java DataBase Connectivity) : Java에서 DB 연결할 수 있게 해주는 Java Programming API (Java에 기본 내장된 인터페이스)
		// java.sql 패키지에서 제공 
		...
		ResultSet rs = null;
		// SELECT 질의 성공 시 반환되느넫 
		// 조회 결과 집합을 나타내는 객체 	
		
		
		try {
			// 2 단계 : 참조변수에 알맞은 객체 대입 
			
			// 1. DB 연결에 필요한 Oracle JCBC Driver 메모리에 로드하기
			...
			while( rs.next() ) {
				...
				// rs.get자료형("컬럼명") 
			 	...
			 	//java.sql.Date
			 	Date hireDate = rs.getDate("HIRE_DATE"); // YYYY-MM-DD 
			...
			// Connection, Statment, ResultSet 생성 역순으로 닫는것을 권장 
